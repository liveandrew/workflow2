...
describe 'HumanReadableJsonProtocol' do
  ...
  describe Thrift::HumanReadableJsonProtocol do
    before(:each) do
      @trans = Thrift::MemoryBufferTransport.new
      @prot = Thrift::HumanReadableJsonProtocol.new(@trans)
    end
    ...
    it "should write bool" do
      ...
      @trans.read(@trans.available).should == "true"

      @prot.write_bool(false)
      @trans.read(@trans.available).should == "false"
    end
  ...
  describe Thrift::HumanReadableJsonProtocolFactory do
    it "should create a HumanReadableJsonProtocol" do
      Thrift::HumanReadableJsonProtocolFactory.new.get_protocol(mock("MockTransport")).should be_instance_of(Thrift::HumanReadableJsonProtocol)
    end
  end
end
