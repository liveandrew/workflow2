...
public class TestMultiStepAction extends JavaSupportTestCase {
  ...
  private final static MultiStepAction msa =
      new MultiStepAction("blah", Arrays.asList(a, b, c, d, e, f, g));
