...
public class HDFSIOServlet implements JSONServlet.Processor{

  private static final Multimap<String, String> COUNTERS_TO_RECORD = HashMultimap.create();

  static {
    COUNTERS_TO_RECORD.put("org.apache.hadoop.mapreduce.FileSystemCounter", "HDFS_BYTES_READ");
    COUNTERS_TO_RECORD.put("org.apache.hadoop.mapreduce.FileSystemCounter", "HDFS_BYTES_WRITTEN");
  }
