...
docker tag workflow2_ui:${VERSION} ${WORKFLOW_UI_REPO}
...
docker tag workflow2_monitor:${VERSION} ${WORKFLOW_MONITOR_REPO}
...
docker tag workflow2_examples:${VERSION} ${WORKFLOW_EXAMPLES_REPO}
