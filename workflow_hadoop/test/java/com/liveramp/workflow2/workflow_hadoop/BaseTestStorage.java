...
public abstract class BaseTestStorage<STORAGE extends Storage.Factory<ROOT>, ROOT> extends ResourcefulTestCase {
  ...
  protected final String scope = getTestRoot() + "/resources";
