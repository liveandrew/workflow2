...
public class WorkflowDbPersistenceFactory extends CoreWorkflowDbPersistenceFactory<Step, WorkflowOptions,
    DbHadoopWorkflow> {
  ...
  @Override
  public DbHadoopWorkflow construct(String workflowName, WorkflowOptions options,
