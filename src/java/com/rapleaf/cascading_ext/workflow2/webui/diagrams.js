...
function renderDiagram (canvasElementId, diagramNodes) {
  nodes = diagramNodes;
...
function drawNodeDiv(canvasElement, nodeId) {
  ...
  if (node.collapsable) {
    collapseButton = document.createElement('input');
    collapseButton.type = 'submit';
    collapseButton.name = 'collapse';
    collapseButton.id = 'collapse_' + node.full_name;
    collapseButton.value = node.full_name;
    collapseButton.style.display = 'none';
    
    collapseLabel = document.createElement('label');
    collapseLabel.htmlFor = 'collapse_' + node.full_name;
    collapseLabel.innerHTML = '&ndash;';
    collapseLabel.className = 'collapse';
    
    box.appendChild(collapseButton);
    box.appendChild(collapseLabel);
  }
  if (node.expandable) {
    expandButton = document.createElement('input');
    expandButton.type = 'submit';
    expandButton.name = 'expand';
    expandButton.id = 'expand_' + node.full_name;
    expandButton.value = node.full_name;
    expandButton.style.display = 'none';

    expandLabel = document.createElement('label');
    expandLabel.htmlFor = 'expand_' + node.full_name;
