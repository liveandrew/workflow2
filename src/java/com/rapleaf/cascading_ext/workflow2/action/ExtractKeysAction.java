...
public class ExtractKeysAction extends RelevanceAction {
  ...
  public ExtractKeysAction(DataStore source,
      BucketDataStore output,
      String outField,
      RelevanceFunction func,
      Class type) {
    this(source, output, outField, func, type, Collections.emptyMap());
  }
  ...
  public ExtractKeysAction(DataStore source,
      ...
      String outField,
      RelevanceFunction func) {
    this(source, output, outField, func, byte[].class, Collections.emptyMap());
  }
  ...
  public ExtractKeysAction(DataStore source,
    ...
    this(source, output, outField, func, byte[].class, userProperties);
  }
