...
public class BatchQueryAction extends RelevanceAction {
  ...
  public BatchQueryAction(String checkPointToken, Class relevanceClass, DataStore source, DataStore output, RelevanceFunction func, DataStore keys) {
    this(checkPointToken, relevanceClass, source, output, func, keys, true, true);
  }
  
  public BatchQueryAction(String checkPointToken, Class relevanceClass, DataStore source, DataStore output, RelevanceFunction func, DataStore keys, boolean useBloom, boolean exact) {
