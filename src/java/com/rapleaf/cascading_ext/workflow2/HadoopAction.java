...
public abstract class HadoopAction extends BaseAction<WorkflowRunner.ExecuteConfig> {
  ...
  public HadoopAction(String checkpointToken) {
    this(checkpointToken, Maps.newHashMap());
  }

  public HadoopAction(String checkpointToken, String tmpRoot) {
    this(checkpointToken, tmpRoot, Maps.newHashMap());
  }

  public HadoopAction(String checkpointToken, Map<Object, Object> properties) {
    this(checkpointToken, null, properties);
  }

  public HadoopAction(String checkpointToken, String tmpRoot, Map<Object, Object> properties) {
  ...
  public class PreExecuteContext {
    ...
    public <T> T get(OldResource<T> resource) throws IOException {
      return HadoopAction.this.get(resource);
    }
  ...
  public class ConstructContext {
    ...
    public void creates(DataStore store) {
      HadoopAction.this.creates(store);
    }

    public <T> void uses(OldResource<T> resource) {
      HadoopAction.this.uses(resource);
    }

    public <T> ReadResource<T> readsFrom(Resource<T> resource) {
      return HadoopAction.this.readsFrom(resource);
    }
